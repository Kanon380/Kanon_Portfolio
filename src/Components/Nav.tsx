      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="-mr-2 -my-2 md:hidden">
            <button type="button" onClick={ () => setOpen(true) } className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Skill </a>
            <a href="#" className="text-base font-medium text-gray-500 hover:text-gray-900"> Work </a>
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <a href="#" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-2 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
        ...
        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          <div className="pt-5 pb-6 px-5">
            <div className="flex items-center justify-between">
              ...
              <div className="-mr-2">
                <button type="button" onClick={ () => setOpen(false) } className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <div className="mt-6">
              <nav className="grid gap-y-8">
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <span className="ml-3 text-base font-medium text-gray-900"> Skill </span>
                </a>
                ...
                <a href="#" className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-50">
                  ...
                  <span className="ml-3 text-base font-medium text-gray-900"> Profile </span>
                </a>
